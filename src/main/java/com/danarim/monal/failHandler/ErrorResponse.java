...
/**
 * Used to return an error response to the client. Do not use constructors directly, use the static methods instead.
 *
 ...
 *                  Use {@link ResponseErrorType#GLOBAL_ERROR} value for global errors
 *                  and {@link ResponseErrorType#SERVER_ERROR} value for server errors.
 *                  The reason for this is that the client can use this to display the error message
...
public record ErrorResponse(
    ...
    public static ErrorResponse fieldError(String errorCode, String fieldName, String message) {
        return new ErrorResponse("fieldValidationError", errorCode, fieldName, message);
    }
    ...
    public static ErrorResponse globalError(String errorCode, String message) {
        return new ErrorResponse("globalError", errorCode, "globalError", message);
    }
    ...
    public static ErrorResponse serverError(String errorCode, String message) {
        return new ErrorResponse("serverError", errorCode, "serverError", message);
    }
}
